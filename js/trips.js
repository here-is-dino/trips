...
const TRIPS = [
{
    ...
    stops: {
      'tsepina-fortress': {
        ...
        image: 'assets/images/tsepina-fortress.jpg',
        description: {
    ...
    days: [
      {
        ...
        schedule: [
          ...
          { time: '14:00', activity: { en: 'Climb to the plateau — road winds up through pine forest. Temperature drops noticeably. Clement nap window', bg: 'Изкачване на платото — пътят се извива нагоре през борова гора. Температурата пада забележимо. Прозорец за сън на Климент' }, icon: '🚐' },
    ...
    stops: {
      ...
      'sapareva-banya': {
        ...
        tips: {
          ...
          bg: 'Занесете плувни памперси за Климент. Арчи ще трябва да изчака в фурона (има сенчесто паркиране). Откритият басейн е най-хубав следобед. Кърпите могат да се наемат на място.',
        },
        kidFriendly: true, dogFriendly: false,
        accessibility: { en: 'Fully stroller-friendly', bg: 'Напълно подходящо за количка' },
      ...
      'maistora-gallery': {
        ...
        bestTime: { en: 'Mid-morning (10am-12pm)', bg: 'Следобед (10-12ч)' },
        duration: { en: '45 min - 1 hour', bg: '45 мин - 1 час' },
        mapsUrl: 'https://www.google.com/maps/place/?cid=12527108983561601963',
      },
      'sequoia-trees': {
        ...
        mapsUrl: 'https://www.google.com/maps/place/?cid=14637100042124943459',
      },
    },
    days: [
      {
        ...
        schedule: [
          ...
          { time: '16:00', activity: { en: 'Clement nap in stroller / free play', bg: 'Климент спи в количката / свободна игра' }, icon: '😴' },
        ...
        notes: { en: 'Wild camping in Osogovo foothills. Bring water — no facilities. Archie can roam free. Clement sleeps in the pop-top.', bg: 'Див къмпинг в подножието на Осогово. Носи вода — няма удобства. Арчи може да се разхожда свободно. Климент спи в покрива.' },
        gallery: []
      },
      {
        day: 2,
        ...
        notes: { en: 'Thermal pools are stroller-friendly. Bring swim diapers for Clement. Archie waits in the van (shaded, ventilated).', bg: 'Термалните басейни са подходящи за количка. Занесете плувни памперси за Климент. Арчи чака в фурона (сенчесто, проветрено).' },
        gallery: []
      }
    ],
    packing: {
      ...
      bg: ['Походна палатка (резервно спане)', 'Плувни принадлежности + кърпи', 'Плувни памперси x10', 'Количка', 'Повод за Арчи + преносима купа', 'Раница за Климент', 'Хладилник + 20л вода', 'Преносима печка + газ', 'Аптека', 'Фенери', 'Външна батерия', 'Камера'],
    },
    budget: {
